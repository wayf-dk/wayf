 ...
 *
 * @author JAcob Christiansen <jach@wayf.dk>, WAYF
 ...
 * @version $Id$
 */
class sspmod_discotango_Discotango {
...
//					$this->returnIdParam => $idp,
		 ...
		 */
		$t = new SimpleSAML_XHTML_Template($this->config, 'discotango:discotango.tpl.php', 'disco');
